...
const TO_EMAIL    = 'aikawa@leciel-webdesign.com';
const FROM_EMAIL  = 'LE CIEL WEB DESIGN <no-reply@leciel-webdesign.com>';
const SITE_NAME   = 'LE CIEL WEB DESIGN';
const SITE_URL    = 'https://leciel-webdesign.com/';
...
<div style="font-family: -apple-system, BlinkMacSystemFont, \'Hiragino Sans\', \'Yu Gothic\', sans-serif; max-width: 640px; margin: 0 auto; padding: 24px; color: #222;">
  <h2 style="border-bottom: 2px solid #1d4ed8; padding-bottom: 10px; font-size: 18px;">' . esc(SITE_NAME) . '｜お問い合わせ受信</h2>
  <p style="font-size: 13px; color: #666;">受信日時: ' . esc($now) . '</p>
  <table style="width:100%; border-collapse: collapse; font-size: 14px; margin-top: 16px;">
    <tr><th align="left" style="padding:10px; background:#f3f6fb; width: 32%; border:1px solid #d9e2f1;">お名前 / 会社名</th><td style="padding:10px; border:1px solid #d9e2f1;">' . esc($name) . '</td></tr>
    <tr><th align="left" style="padding:10px; background:#f3f6fb; border:1px solid #d9e2f1;">メールアドレス</th><td style="padding:10px; border:1px solid #d9e2f1;">' . esc($email) . '</td></tr>
    <tr><th align="left" style="padding:10px; background:#f3f6fb; border:1px solid #d9e2f1;">業種・業態</th><td style="padding:10px; border:1px solid #d9e2f1;">' . esc($businessType !== '' ? $businessType : '未入力') . '</td></tr>
    <tr><th align="left" style="padding:10px; background:#f3f6fb; border:1px solid #d9e2f1; vertical-align: top;">ご相談内容</th><td style="padding:10px; border:1px solid #d9e2f1;">' . nl2br_esc($message) . '</td></tr>
    <tr><th align="left" style="padding:10px; background:#f3f6fb; border:1px solid #d9e2f1;">参考サイトURL</th><td style="padding:10px; border:1px solid #d9e2f1;">' . esc($referenceUrl !== '' ? $referenceUrl : '未入力') . '</td></tr>
  </table>
  <p style="margin-top: 24px; font-size: 12px; color: #888;">このメールは leciel-webdesign.com のお問い合わせフォームから自動送信されました。</p>
</div>';
...
<div style="font-family: -apple-system, BlinkMacSystemFont, \'Hiragino Sans\', \'Yu Gothic\', sans-serif; max-width: 640px; margin: 0 auto; padding: 24px; color: #222; line-height: 1.8;">
  <div style="text-align:center; padding: 8px 0 20px; border-bottom: 1px solid #d9e2f1;">
    <div style="font-family: Georgia, serif; letter-spacing: 0.24em; color: #1d4ed8; font-size: 14px;">' . esc(SITE_NAME) . '</div>
    <div style="color: #888; font-size: 11px; letter-spacing: 0.2em; margin-top: 4px;">ル・シエルウェブデザイン</div>
  </div>
  ...
  <div style="background:#f7faff; border:1px solid #d9e2f1; padding: 18px 20px; margin: 24px 0; border-radius: 4px;">
    <p style="margin: 0 0 12px; font-weight: bold; color: #1d4ed8; font-size: 13px; letter-spacing: 0.1em;">▼ お問い合わせ内容</p>
  ...
  <div style="margin-top: 32px; padding-top: 20px; border-top: 1px solid #eee; font-size: 12px; color: #888; line-height: 1.7;">
    <div style="font-family: Georgia, serif; letter-spacing: 0.2em; color: #1d4ed8; font-size: 12px; margin-bottom: 6px;">' . esc(SITE_NAME) . '</div>
    <div>個人店舗・個人事業主から中小企業・法人まで対応するホームページ制作サービス</div>
    <div>Web: <a href="' . esc(SITE_URL) . '" style="color:#1d4ed8; text-decoration:none;">' . esc(SITE_URL) . '</a></div>
    <div>Mail: <a href="mailto:' . esc(TO_EMAIL) . '" style="color:#1d4ed8; text-decoration:none;">' . esc(TO_EMAIL) . '</a></div>
  </div>
</div>';
